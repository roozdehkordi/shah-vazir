...
namespace NoSuchStudio.Localization.Source.Editor {
    [CustomEditor(typeof(JsonTranslationSource))]
    public class JsonTranslationSourceEditor : BaseTranslationSourceEditor<JsonTranslationSourceEditor, JsonTranslationSource> {
        SerializedProperty textAssetField;
        Dictionary<string, bool> phraseFoldStates;

        protected override void OnEnable() {
            base.OnEnable();
            textAssetField = serializedObject.FindProperty("_textAsset");
